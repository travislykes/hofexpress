...
<section class="content">
    ...
    <div class="row">
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create Payment Type</h4>
                        <h6 class="box-subtitle">All Payments On Site <a class="text-warning" href="#">Hof Express </a></h6>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form novalidate method="POST" action="{{ route('admin.payment.types.store') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
        ...
        <div class="col-xl-8 col-lg-8 col-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Supported Payment Types</h4>
                    <h6 class="box-subtitle">List of all created payment types</h6>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.payment.type.delete',[$paymentType->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button onclick=" return confirm('Delete Payment Type {{ $paymentType->name }} ?')" class="text-danger" data-toggle="tooltip" data-original-title="Delete"  class="btn btn-sm btn-danger ml-2"><i class="ti-trash" aria-hidden="true"></i></button>
                                        </form>
