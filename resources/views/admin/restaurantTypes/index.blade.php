...
<section class="content">
    ...
    <div class="row">
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create Restaurant Type</h4>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form novalidate method="POST" action="{{ route('admin.restaurant.types.store') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
        ...
        <div class="col-xl-8 col-lg-8 col-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Supported Restaurant Types</h4>
                    <h6 class="box-subtitle">List of all created restaurant types</h6>
                </div>
