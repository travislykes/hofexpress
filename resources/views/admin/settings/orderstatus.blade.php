...
<section class="content">
    ...
    <div class="row">
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Create Order Status</h4>
                        <h6 class="box-subtitle">Status Assigned To Orders <a class="text-warning" href="#">Hof Express </a></h6>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form novalidate method="POST" action="{{ route('admin.orderStatus.store') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
        ...
        <div class="col-xl-8 col-lg-8 col-12">
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Order Statuses </h4>
                    <h6 class="box-subtitle">List of all statuses</h6>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.orderStatus.delete',[$orderStatus->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button onclick=" return confirm('Delete order Status {{ $orderStatus->name }} ?')" class="text-danger" data-toggle="tooltip" data-original-title="Delete"  class="btn btn-sm btn-danger ml-2"><i class="ti-trash" aria-hidden="true"></i></button>
                                        </form>
